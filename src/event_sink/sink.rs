...
pub struct RetryConfig {
    ...
    /// Initial delay between retries (in seconds). A minimum of 1 second is enforced.
...
impl BaseEventSink {
    ...
    pub fn get_retry_delay(&self) -> std::time::Duration {
        // Enforce a minimum delay of 1 second to prevent rapid retries
        let min_delay_secs = 1.0;
